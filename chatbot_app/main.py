...
with gr.Blocks(theme=theme) as demo:
    gr.Markdown(
        """
        # Resource Human Contoso Assistant

        This assistant answers queries related to Human Resources (RH) for Contoso.  
        It can help you access HR data, provide insights, and answer questions about employees, departments, and HR metrics.  
        This is a demo example showing AI agent capabilities with Databricks for HR use cases.
        """
    )
    ...
    with gr.Row():
        textbox = gr.Textbox(
            placeholder="Ask about rh Contoso data...",
            container=False,
            scale=7
        )
